...
namespace _Presentation.Controllers
{
    public class RouteNodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DestinationStationCode,OriginStationCode,DestinationStationName,OriginStationName,Km,Standing,Name,OfficialCode")] RouteNode routeNode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,DestinationStationCode,OriginStationCode,DestinationStationName,OriginStationName,Km,Standing,Name,OfficialCode")] RouteNode routeNode)
        {
            if (id != routeNode.Id)
            {
                return NotFound();
